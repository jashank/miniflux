...
create index document_vectors_idx on entries using gin(document_vectors);`,
	...
	"schema_version_22": `ALTER TABLE feeds ADD COLUMN fetch_disabled BOOLEAN DEFAULT false;
...
var SqlMapChecksums = map[string]string{
	...
	"schema_version_22": "5edc156d75765e1690cbdaf0ca8a87f0874f89eabbe7abe87956682899f5a16f",
